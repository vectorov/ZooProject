...
namespace ZooProject.Commands
{
    class GetSickTigers : ICommand
    {
        ...
        public GetSickTigers(IRepository animalsRepository, string name, int parametersCount = 0, string paramsDescription = "")
        {
        ...
        {
            ((AnimalsRepository)AnimalsRepository).GetSickTigers();
        }
    }
}
