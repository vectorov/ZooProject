...
{
    class GetAllHungryAnimals : ICommand
    {
        ...
        public GetAllHungryAnimals(IRepository animalsRepository, string name, int parametersCount = 0, string paramsDescription = "")
        {
        ...
        {
            ((AnimalsRepository)AnimalsRepository).GetAllHungryAnimals();
        }
    }
}
